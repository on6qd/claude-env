...
export function installHint(binary) {
    ...
    switch (binary) {
        case 'git':
            if (p === 'darwin')
                return 'Install with: brew install git  (or: xcode-select --install)';
            if (p === 'linux')
                return 'Install with: sudo apt install git  (or: sudo dnf install git)';
            return 'Download from https://git-scm.com';
        case 'sops':
            if (p === 'darwin')
                return 'Install with: brew install sops';
            return 'Download from https://github.com/getsops/sops/releases';
        case 'age':
            if (p === 'darwin')
                return 'Install with: brew install age';
            if (p === 'linux')
                return 'Install with: sudo apt install age  (or download from https://github.com/FiloSottile/age/releases)';
